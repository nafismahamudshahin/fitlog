import { IExerciseTypeProp } from '@/types/types';
import Image from 'next/image';
import { FaFireAlt, FaStarHalfAlt } from 'react-icons/fa';
import { GoClock } from 'react-icons/go';

const WorkoutCard = ({ exercise }: IExerciseTypeProp) => {
    const { name, image, muscleGroups, equipment, duration, caloriesBurned, rating } = exercise;
    return (
